...
public class DeliverySchedulingSystem extends javax.swing.JFrame {
    ...
    private void loadDeliveryData() {
        try {
            List<DeliverySchedule> list = DeliveryScheduleDAO.getAllDeliveries();
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            for (DeliverySchedule ds : list) {
    ...
    private void initComponents() {
        ...
        // Your existing layout & component code remains here
        // Add your action listeners below

        jButton1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                DeliverySchedule ds = new DeliverySchedule();
                ds.setCustomerName(jTextField1.getText());
                ds.setDeliveryDate(jTextField8.getText());
                ds.setShipmentId(1); // Example: use real value

                try {
                    DeliveryScheduleDAO.addDelivery(ds);
                    loadDeliveryData();
        ...
        jButton5.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (selectedId == -1) {
                    JOptionPane.showMessageDialog(null, "No delivery selected to update.");
                    return;
                }
                DeliverySchedule ds = new DeliverySchedule();
                ds.setId(selectedId);
                ...
                try {
                    DeliveryScheduleDAO.updateDelivery(ds);
                    loadDeliveryData();
                    JOptionPane.showMessageDialog(null, "Delivery updated!");
                    selectedId = -1;
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
                }
        ...
        jButton3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (row >= 0) {
                    ...
                    try {
                        DeliveryScheduleDAO.deleteDelivery(id);
                        loadDeliveryData();
